...
const Login = (props) => {
  ...
  return (
    <Fragment>
      {popup && <SuccessPopup popup={popup} setPopup={setPopup} />}
      ...
      {layoutData.loginSignupError ? (
        <div className="bg-red-200 py-2 px-4 rounded">
          Vous devez vous connecter pour passer la commande. Vous n'avez pas de
...
export const SuccessPopup = ({ setPopup }) => {
  return (
    <div className="fixed top-0 left-0  p-64 w-full h-full bg-black bg-opacity-50 z-50">
      <div className="w-64 bg-white rounded-lg mx-auto p-8">
        <div className="grid justify-center items-center h-full">
          ...
          <div className="text-center text-md font-semibold text-green-600">
            {/* message pour dire que le mail de reinitialisation a été envoyé */}
            Un email de reinitialisation a été envoyé
          </div>
          <div
