    ...
    <Fragment>
      <div className="col-span-1 overflow-auto bg-white shadow-lg p-4">
        <table className="table-auto border w-full my-2">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 border">Totale</th>
              <th className="px-4 py-2 border">Id Transaction</th>
              ...
              <th className="px-4 py-2 border">Créé à</th>
              <th className="px-4 py-2 border">Modifiée à</th>
        ...
        <div className="text-sm text-gray-600 mt-2">
          Totale {orders && orders.length} commandes
        </div>
      </div>
    </Fragment>
  );
