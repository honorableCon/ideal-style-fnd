    ...
    <Fragment>
      <div className="col-span-1 overflow-auto bg-white shadow-lg p-4">
        <table className="table-auto border w-full my-2">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 border">Statuts</th>
              <th className="px-4 py-2 border">Stock</th>
              <th className="px-4 py-2 border">Catégorie</th>
              <th className="px-4 py-2 border">Offre</th>
              <th className="px-4 py-2 border">Créé à</th>
              <th className="px-4 py-2 border">Modifié à</th>
        ...
        <div className="text-sm text-gray-600 mt-2">
          Totale {products && products.length} produits
        </div>
      </div>
    </Fragment>
  );
