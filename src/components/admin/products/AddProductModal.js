        ...
        <div className="mt-32 md:mt-0 relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 px-4 py-4 md:px-8">
          ...
          <form className="w-full" onSubmit={(e) => submitForm(e)}>
            ...
            <div className="flex flex-col mt-4">
              ...
              <span className="text-gray-600 text-xs">Mnimum 2 Images *</span>
              <input
                onChange={(e) =>
                  setFdata({
                    ...fData,
            ...
            <div className="flex space-x-1 py-4">
              <div className="w-1/2 flex flex-col space-y-1">
                <label htmlFor="status">Statuts Du Produit *</label>
                <select
                  value={fData.pStatus}
                  onChange={(e) =>
                    setFdata({
              ...
              <div className="w-1/2 flex flex-col space-y-1">
                <label htmlFor="status">Catégorie Du Produit *</label>
                <select
            ...
            <div className="flex space-x-1 py-4">
              <div className="w-1/2 flex flex-col space-y-1">
                <label htmlFor="quantity">Produit En Stock *</label>
                <input
              ...
              <div className="w-1/2 flex flex-col space-y-1">
                <label htmlFor="offer">Promo (%) *</label>
                <input
                  value={fData.pOffer}
                  onChange={(e) =>
                    setFdata({
