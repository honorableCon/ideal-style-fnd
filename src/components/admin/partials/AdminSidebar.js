    ...
    <Fragment>
      ...
      >
        ...
        >
          ...
          <span className="hover:text-gray-800">Tableau de bord</span>
        </div>
        ...
        >
          ...
          <span className="hover:text-gray-800">Catégories</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
        ...
        >
          ...
          <span className="hover:text-gray-800">Produit</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
        ...
        >
          ...
          <span className="hover:text-gray-800">Commandes</span>
        </div>
        <hr className="border-b border-gray-200" />
      </div>
    </Fragment>
